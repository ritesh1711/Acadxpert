...
const css = {
  ...
  name: { fontWeight: 600 } as React.CSSProperties,
  badge: {
    minWidth: 20,
    height: 20,
    borderRadius: 10,
  ...
  sub: { fontSize: 12, color: 'var(--muted)', marginTop: 4 } as React.CSSProperties,
  chatHead: {
    padding: 14,
    borderBottom: '1px solid var(--cardStroke)',
    display: 'flex',
  ...
  meta: { fontSize: 11, color: 'var(--muted)', marginTop: 4 } as React.CSSProperties,
  typing: {
    display: 'inline-flex',
    gap: 4,
    alignItems: 'center',
  ...
  small: { fontSize: 12, color: 'var(--muted)' } as React.CSSProperties,
};
